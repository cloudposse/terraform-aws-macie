...
| <a name="output_classification_job_ids"></a> [classification\_job\_ids](#output\_classification\_job\_ids) | The ID of the Macie Classification Jobs. |
| <a name="output_custom_data_identifier_ids"></a> [custom\_data\_identifier\_ids](#output\_custom\_data\_identifier\_ids) | The ID of the Macie Custom Data Identifiers. |
| <a name="output_findings_filters_arns"></a> [findings\_filters\_arns](#output\_findings\_filters\_arns) | The ARN of the Macie Findings Filters. |
| <a name="output_findings_filters_ids"></a> [findings\_filters\_ids](#output\_findings\_filters\_ids) | The ID of the Macie Findings Filters. |
